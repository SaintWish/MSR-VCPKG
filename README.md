...
* `sudo apt update`
* `sudo apt install -y g++-11-multilib libgcc-s1:i386 libstdc++6:i386 libatomic1:i386 libgl1-mesa-dev:i386 pkg-config`
* `sudo apt install -y gcc-i686-linux-gnu g++-i686-linux-gnu` - https://github.com/microsoft/vcpkg/issues/45472
* `./build-linux.sh`
